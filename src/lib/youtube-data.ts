...
export const shortsVideos: Video[] = [
  ...
  createVideo('Kp5f7VbL3nM', 'POV: You finally understand coding 💻', 'Fireship', '18M views', '3 months ago', '0:16', 'When code finally compiles without errors.', 'Programming', '2.8M'),
  createVideo('Rj8Xq3mN2wP', 'This street food looks incredible 🍜', 'Mark Wiens', '25M views', '5 months ago', '0:30', 'Amazing street food from Bangkok night market.', 'Travel', '10M'),
  createVideo('Wt4pK8hL2vC', 'I gave away $10,000 to strangers 💰', 'MrBeast', '350M views', '4 months ago', '0:22', 'MrBeast gives away money to random people.', 'Entertainment', '230M'),
  createVideo('Yn6Qf4mR8xJ', 'How to peel a potato in 5 seconds 🥔', '5-Minute Crafts', '32M views', '1 year ago', '0:18', 'Quick kitchen hack for peeling potatoes.', 'Cooking', '80M'),
  createVideo('Dh3kL7pW2mB', 'The most insane basketball shot ever 🏀', 'Dude Perfect', '85M views', '6 months ago', '0:15', 'Dude Perfect makes the most impossible basketball shot.', 'Sports', '62M'),
  createVideo('Fk9N2qR4xHs', 'My cat learned to high five 🐱', 'The Dodo', '28M views', '2 months ago', '0:20', 'Cat learns to give high fives on command.', 'Pets', '12M'),
  createVideo('Pm6J8wR3tYv', 'Wait for the drop... 🔥', 'Alan Walker', '45M views', '3 months ago', '0:30', 'Alan Walker shorts - epic music drop moment.', 'Music', '44M'),
  createVideo('Gq4L9hN2wKf', 'Making ramen from scratch in 60 seconds 🍜', 'Joshua Weissman', '15M views', '4 months ago', '0:45', 'Quick ramen from scratch - time-lapse cooking.', 'Cooking', '8.5M'),
  createVideo('Vb3R7mK2xPc', 'POV: Your code works on the first try 😱', 'Web Dev Simplified', '12M views', '6 months ago', '0:14', 'When your code runs perfectly the first time.', 'Programming', '1.5M'),
  createVideo('Xn8Q5pL3wRd', 'Satisfying kinetic sand cutting 🏖️', 'ASMR Zone', '55M views', '1 year ago', '0:22', 'Most satisfying kinetic sand cutting ASMR.', 'Entertainment', '5.5M'),
  createVideo('Jc5K9mN2xQg', 'Gordon Ramsay reacts to bad cooking 😡', 'Gordon Ramsay', '42M views', '3 months ago', '0:35', 'Gordon Ramsay loses it over terrible cooking.', 'Cooking', '23M'),
  createVideo('Az7L4pR8wNm', 'This dog is smarter than most humans 🐕', 'The Dodo', '38M views', '5 months ago', '0:18', 'Incredibly smart dog solves complex puzzles.', 'Pets', '12M'),
  createVideo('Tf2H8qK4xRp', 'How to tie a tie in 10 seconds 👔', '5-Minute Crafts', '22M views', '1 year ago', '0:15', 'Quick and easy tie-tying tutorial.', 'Learning', '80M'),
  createVideo('Mb6N3kP8wLs', 'Elden Ring boss fight in 30 seconds ⚔️', 'IGN', '15M views', '8 months ago', '0:30', 'Elden Ring epic boss fight highlights.', 'Gaming', '18M'),
  createVideo('Hd4R7mL2xKn', 'The most beautiful place on Earth 🌍', 'Drew Binsky', '12M views', '3 months ago', '0:25', 'Stunning drone footage of the most beautiful place on Earth.', 'Travel', '3.8M'),
  createVideo('Uw5P9nR3xQm', 'POV: Monday morning meeting 😴', 'Corporate Bro', '22M views', '2 months ago', '0:12', 'Relatable Monday morning meeting POV.', 'Comedy', '2.5M'),
  createVideo('Lk8N4fP6xRs', 'How to do a backflip tutorial 🤸', 'Fitness Blender', '8.5M views', '6 months ago', '0:30', 'Step by step backflip tutorial for beginners.', 'Fitness', '8.5M'),
  createVideo('Cv7M2hL4xWt', 'This painting came to life 🎨', 'Art for Kids Hub', '15M views', '4 months ago', '0:22', 'Amazing painting that looks incredibly realistic.', 'Art', '8M'),
  createVideo('Yf3K8pN6xQg', 'Minecraft speed build in 45 seconds ⛏️', 'Minecraft', '28M views', '3 months ago', '0:45', 'Incredible Minecraft speed build - medieval castle.', 'Gaming', '12M'),
  createVideo('Bn5Q7mR9xLp', 'Fastest pizza maker in the world 🍕', 'Gordon Ramsay', '18M views', '5 months ago', '0:20', 'Incredible speed pizza making - world record attempt.', 'Cooking', '23M'),
  createVideo('Ep8L3nK5xRq', 'The science of black holes in 60 seconds 🌌', 'Kurzgesagt – In a Nutshell', '22M views', '2 months ago', '0:55', 'Black holes explained in under 60 seconds by Kurzgesagt.', 'Science', '22M'),
  createVideo('Ig4M6pN8xSt', 'This football trick shot is impossible 🏈', 'Dude Perfect', '45M views', '4 months ago', '0:18', 'Dude Perfect attempts impossible football trick shot.', 'Sports', '62M'),
  createVideo('Ok7N4mL9xVu', 'POV: You find money in your old jacket 💰', 'Khaby Lame', '35M views', '3 months ago', '0:10', 'That feeling when you find forgotten money.', 'Comedy', '82M'),
  createVideo('Wp6Q8nR2xYb', 'Making the perfect omelette in 30 seconds 🥚', 'Gordon Ramsay', '32M views', '6 months ago', '0:28', 'Gordon Ramsay perfect omelette in record time.', 'Cooking', '23M'),
  createVideo('Zr9L5mK3xAf', 'AI can now do YOUR job 🤖', 'Fireship', '20M views', '1 month ago', '0:35', 'Fireship explains how AI is replacing jobs in 2025.', 'Programming', '2.8M'),
  createVideo('Ac4N7pL2xHg', 'The cutest puppy ever born 🐶', 'The Dodo', '45M views', '2 months ago', '0:15', 'The most adorable newborn puppy you have ever seen.', 'Pets', '12M'),
  createVideo('Sd6P8mN4xJk', 'Taylor Swift surprise song mashup 🎵', 'Taylor Swift', '25M views', '4 months ago', '0:45', 'Epic Taylor Swift surprise song mashup from Eras Tour.', 'Music', '56M'),
  createVideo('Vf8K3pR6xNm', 'How to save $1000 in one month 💵', 'Graham Stephan', '15M views', '5 months ago', '0:40', 'Simple tips to save $1000 in just one month.', 'Learning', '5.5M'),
  createVideo('Hj5L9mN3xPq', 'This drone footage will blow your mind 🚁', 'Drew Binsky', '18M views', '3 months ago', '0:25', 'Incredible drone footage of Iceland from above.', 'Travel', '3.8M'),
  createVideo('Km7N4pR2xWs', 'Gym fail vs gym win 💪', 'Chris Heria', '12M views', '1 month ago', '0:18', 'Epic gym fails and wins compilation.', 'Fitness', '4.5M'),
  createVideo('Nx8Q5mL3xRt', 'POV: Your first day as a software developer 💻', 'Theo - t3.gg', '14M views', '2 months ago', '0:20', 'First day as a software developer - the reality.', 'Programming', '850K'),
  createVideo('Qw9R6mK4xYf', 'How to make sushi in 60 seconds 🍣', 'Joshua Weissman', '20M views', '3 months ago', '0:50', 'Making fresh sushi from scratch - speed cooking.', 'Cooking', '8.5M'),
  createVideo('Ty4S7mN5xZg', 'The most satisfying domino fall ever 🁡', 'Dude Perfect', '55M views', '1 month ago', '0:22', 'Incredible domino chain reaction - most satisfying ever.', 'Entertainment', '62M'),
  createVideo('Lp6W8mR3xNh', 'I Tried Every Fast Food Burger 🍔', 'MrBeast', '280M views', '2 months ago', '0:55', 'MrBeast tries every fast food burger and ranks them.', 'Entertainment', '230M'),
  createVideo('Dg3K7pN4xMj', 'Science experiment with liquid nitrogen 🧪', 'Veritasium', '18M views', '4 months ago', '0:35', 'Amazing liquid nitrogen experiment - instant freezing.', 'Science', '16M'),
  createVideo('Fr8L4mK6xQp', 'How to juggle in 30 seconds 🤹', '5-Minute Crafts', '8M views', '6 months ago', '0:28', 'Quick juggling tutorial - learn to juggle fast.', 'Learning', '80M'),
];
