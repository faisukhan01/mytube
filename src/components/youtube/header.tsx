    ...
    <>
      <header className="fixed top-0 left-0 right-0 h-14 bg-white dark:bg-[#0f0f0f] z-50 flex items-center justify-between px-4 border-b border-gray-100 dark:border-gray-800">
        ...
        <div className="flex items-center gap-4 min-w-0">
          ...
          >
            {/* YouTube Logo - Official wordmark */}
            <svg viewBox="0 0 90 20" className="h-5 w-auto cursor-pointer" preserveAspectRatio="xMidYMid meet" onClick={handleLogoClick}>
              <g>
        ...
        <div className="hidden md:flex items-center flex-1 max-w-[640px] mx-4">
          <form onSubmit={handleSearch} className="flex flex-1">
            <div className={`flex flex-1 items-center border rounded-l-full overflow-hidden ${searchFocused ? 'border-blue-500 shadow-inner dark:border-blue-500' : 'border-gray-300 dark:border-gray-700'}`}>
              {searchFocused && (
                <div className="pl-4">
              ...
              <input
                ...
                placeholder="Search"
                className="w-full py-2 px-4 text-base outline-none bg-transparent placeholder-gray-500 dark:text-white dark:placeholder-gray-400"
              />
              {inputValue && (
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-gray-100 dark:bg-[#272727] hover:bg-gray-200 dark:hover:bg-[#3f3f3f] border border-l-0 border-gray-300 dark:border-gray-700 rounded-r-full transition-colors"
              aria-label="Search"
            >
