...
export default function Home() {
      ...
      case 'shorts':
        return (
          <div className="p-4 md:p-6">
            <ShortsSection />
            <div className="mt-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">More Shorts</h2>
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Footer */}
      <footer
        className={`border-t border-gray-200 bg-white py-4 px-6 mt-auto transition-all duration-200 ${getMainClasses()}`}
      >
        <div className="max-w-[2000px] mx-auto">
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs text-gray-500 mb-3">
            ...
            <span className="hover:text-gray-700 cursor-pointer">Press</span>
            ...
            <span className="hover:text-gray-700 cursor-pointer">Creators</span>
            <span className="hover:text-gray-700 cursor-pointer">Advertise</span>
            <span className="hover:text-gray-700 cursor-pointer">Developers</span>
          </div>
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs text-gray-500 mb-3">
            ...
            <span className="hover:text-gray-700 cursor-pointer">Policy & Safety</span>
            <span className="hover:text-gray-700 cursor-pointer">How YouTube works</span>
            <span className="hover:text-gray-700 cursor-pointer">Test new features</span>
          </div>
